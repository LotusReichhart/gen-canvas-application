...
val bottomNavItems = listOf(
    BottomNavItem("Trang chủ", Icons.Default.Home, Route.HOME_TAB_ROUTE),
    BottomNavItem("Tạo Ảnh", Icons.Default.Star, Route.AI_GENERATE_TAB_ROUTE),
    BottomNavItem("Canvas", Icons.Default.Favorite, Route.CANVAS_TAB_ROUTE),
    BottomNavItem("Tài khoản", Icons.Default.Person, Route.ACCOUNT_TAB_ROUTE)
)
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(bottomNavItems[2].route) {
                FakeScreen(bottomNavItems[2].title)
            }

            composable(bottomNavItems[3].route) {
                FakeScreen(bottomNavItems[3].title)
            }
        }
    }
}
...
@Composable
private fun FakeScreen(screenTitle: String) {
    Box(
